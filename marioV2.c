...
alinhada a direita com a altura solicitada ao usuario anteriormente e tambem
imprimir uma outra piramide logo ao lado alinhado para esquerda*/
int main(void)
{
...
for(int j = 0; j < h; j++){
    ...
    // print para dar os dois espaços entre as piramides
    printf("  ");
    //for para imprimir a segunda piramide
    for(int l = 0; l < s; l++){
        printf("#");
    }
printf("\n");
